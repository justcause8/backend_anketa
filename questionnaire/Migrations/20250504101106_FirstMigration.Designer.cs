...
namespace questionnaire.Migrations
{
    ...
    [Migration("20250504101106_FirstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("questionnaire.questionnaire.Models.AccessLevel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("questionnaire.questionnaire.Models.Anonymou", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("questionnaire.questionnaire.Models.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("questionnaire.questionnaire.Models.QuestionType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("questionnaire.questionnaire.Models.Questionnaire", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("questionnaire.questionnaire.Models.QuestionnaireHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("questionnaire.questionnaire.Models.Token", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("questionnaire.questionnaire.Models.TypeQuestionnaire", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("questionnaire.questionnaire.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Answer", b =>
                {
                    b.HasOne("questionnaire.questionnaire.Models.Anonymou", "Anonymous")
                        .WithMany("Answers")
                        .HasForeignKey("AnonymousId")
                        .HasConstraintName("Answer_fk1");

                    b.HasOne("questionnaire.questionnaire.Models.Question", "Question")
                        .WithMany("Answers")
                    ...
                    b.HasOne("questionnaire.questionnaire.Models.User", "User")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("questionnaire.questionnaire.Models.Question", b =>
                {
                    b.HasOne("questionnaire.questionnaire.Models.QuestionType", "QuestionType")
                        .WithMany("Questions")
                        .HasForeignKey("QuestionTypeId")
                        .IsRequired()
                        .HasConstraintName("Question_fk1");

                    b.HasOne("questionnaire.questionnaire.Models.Questionnaire", "Questionnaire")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("questionnaire.questionnaire.Models.Questionnaire", b =>
                {
                    b.HasOne("questionnaire.questionnaire.Models.TypeQuestionnaire", "TypeQuestionnaire")
            ...
            modelBuilder.Entity("questionnaire.questionnaire.Models.User", b =>
                {
                    b.HasOne("questionnaire.questionnaire.Models.AccessLevel", "AccessLevel")
                        .WithMany("Users")
